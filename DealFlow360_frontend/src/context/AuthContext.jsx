  ...
  const permissions = useMemo(() => {
    ...
    if (user.role === 'Admin') {
      return [
        ...
        'products.view', 'products.create', 'products.update', 'products.manage', 'products.manage_status',
        'categories.view', 'categories.create', 'categories.update', 'categories.manage', 'categories.manage_status',
